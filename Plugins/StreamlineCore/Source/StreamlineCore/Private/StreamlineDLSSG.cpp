...
namespace sl
{
	...
	{
		static_assert(uint64_t(DLSSGStatus::eAll) == 63U, "dear NVIDIA plugin developer, please update this code to handle the new sl::DLSSGStatus enum values");
		switch (v)
		{
			...
			SL_CASE_STR(DLSSGStatus::eReserved5);
		};
		return "Unknown";
	}
